...
import backend, { ProjectInfo } from '@/extensions/extra/backup/backend';
import auth from '@/extensions/extra/backup/auth';
...
import { project, ProjectType, IProject } from '@/extensions/core/project';
